...
//    when it is called and then logged into the console.



// 2. Define a function called "divideByTwo". It should accept one parameter called "number".
//    The function should divide the number by two and log the answer to the console.



// 3. Define a function called "greeting". It should accept two parameters, which will both be first names.
//    The function should log to the console a greeting to both people.



// 4. Create a function that finds the average of 6 numbers passed in when called 
//    and returns the value and is then displayed in the console.
...
// 9. Develop a function that determines a person's age by prompting them for their birth year.





// 10. Write a function that accepts the following array and separates the people into two teams.
...
// 11. Prompt a user to enter a three digit number. Write a function that adds the numbers together.
...
//     Write a function that accepts four parameters (quarters, dimes, nickels, and pennies).
